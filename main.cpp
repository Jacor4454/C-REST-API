...
int main(){
    ...
    SVG svg;
    Graphic::PolyLine pl({{0,0},{10,10},{50,90},{600,0}});
    pl.stroke.raw = 0;
    pl.fill.H = 1;
    svg.add(&pl);
    Graphic::RoundedRect rr({100,100}, {20,20}, {200, 100});
    rr.stroke.R = 255;
    rr.fill.raw = 0;
    rr.fill.B = 255;
    svg.add(&rr);
    Graphic::RoundedRect rr1({100,100}, {4,4}, {40, 20});
    rr1.stroke.R = 255;
    rr1.fill.raw = 0;
    rr1.fill.B = 255;
    svg.add(&rr1);
    Graphic::Text t("Hello", {40,400}, 35);
    t.stroke.H = 1;
    t.fill.raw = 0;
    t.fill.G=200;
    svg.add(&t);
    Graphic::RoundedLine rl({{600,700},{600,500},{50,500},{50,700},{200,700}}, 25);
    rl.stroke.R = 255;
    rl.fill.H = 1;
    svg.add(&rl);
    Graphic::WordBubble wb({500,500},"Title","footer");
